...
if __name__ == '__main__':
    ...
    parser.add_argument('--required_images', help = 'require at least n images to consider the pixel as valid', default=1, type=int)
